                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('routes')" :active="route().current('routes')">
                                    Route
                                </NavLink>
                            </div>
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <template v-if="$page.props.jetstream.hasTeamFeatures">
                                                ...
                                                <!-- Team Settings -->
                                                <DropdownLink v-if="isAdmin" :href="route('teams.show', $page.props.user.current_team)">
                                                    Team Settings
                                                </DropdownLink>

                                                <DropdownLink v-if="$page.props.jetstream.canCreateTeams && isAdmin" :href="route('teams.create')">
                                                    Create New Team
                                                </DropdownLink>
